...
def update_status_in_database():
    ...
    try:
        latest_startupindia_entry = rbi_log.objects.using('rbi').filter(source_name='startupindia').latest('Sr_no')
        startupindia_entry, created_startupindia = rbi_log.objects.using('rbi').filter(source_name='startupindia', Sr_no=latest_startupindia_entry.Sr_no).update_or_create(
            source_name='startupindia',
        ...
        startupindia_entry = rbi_log.objects.using('rbi').create(source_name='startupindia', Sr_no=get_unique_sr_no(), source_status=startupindia_status)
